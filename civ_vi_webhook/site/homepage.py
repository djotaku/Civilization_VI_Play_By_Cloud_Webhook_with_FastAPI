...
def sort_games() -> (dict, dict):
    ...
    sorted_by_timestamp = OrderedDict(sorted(all_games.items(), key=lambda k: int(f"{k[1]['time_stamp']['year']}{k[1]['time_stamp']['month']}{k[1]['time_stamp']['day']}{k[1]['time_stamp']['hour']}{k[1]['time_stamp']['minute']}{k[1]['time_stamp']['second']}")))
    current_games = {}
    completed_games = {}
