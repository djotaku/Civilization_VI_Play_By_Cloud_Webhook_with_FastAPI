...
async def add_user(user: User):
    ...
    db_user = await DbUser.find_one(DbUser.steam_username == user.steam_username)
    return db_user or await user_service.create_user(
        user.steam_username,
        maxtrix_username=user.matrix_username,
